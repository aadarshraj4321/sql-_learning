...
const Footer = () => {
  ...
  const handleContactClick = () => {
    window.location.href = 'mailto:contact@ciphersqlstudio.com?subject=CipherSQLStudio Inquiry';
  };
      ...
      <div className="footer__container">
        <div className="footer__content">
          <div className="footer__section">
            <h3 className="footer__section-title">CipherSQLStudio</h3>
            <p className="footer__section-description">
              Master SQL through interactive practice with our professional learning platform. 
              Build your database skills with real-world scenarios, intelligent hints, and 
              immediate feedback.
            </p>
            <div className="footer__contact">
              ...
              <button className="footer__contact-button" onClick={handleContactClick}>
                <svg viewBox="0 0 24 24" fill="none">
                  <path d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" stroke="currentColor" strokeWidth="2"/>
                </svg>
                Contact Me
            ...
            <ul className="footer__links">
              <li>
                <a href="#documentation">
                  <svg viewBox="0 0 24 24" fill="none">
                    <path d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" stroke="currentColor" strokeWidth="2"/>
                  </svg>
                  Documentation
                </a>
              </li>
              ...
              <li>
                <a href="#examples">
                  <svg viewBox="0 0 24 24" fill="none">
                    <path d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" stroke="currentColor" strokeWidth="2"/>
                  </svg>
                  Code Examples
                </a>
              </li>
        ...
        <div className="footer__bottom">
          <div className="footer__copyright">
            © {currentYear} CipherSQLStudio. Built with passion for SQL education.
          </div>
          <div className="footer__social">
            ...
            <a href="#linkedin" onClick={handleLinkedInClick} title="LinkedIn">
              <svg viewBox="0 0 24 24" fill="currentColor">
